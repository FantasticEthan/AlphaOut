...
test_result["lt10_prob"] = test_y
# test_result["lt12_prob"] = test_result["lt12_prob"].apply(lambda x: 1 if x >= 0.5 else 0)
test_result.to_csv("../tmp/lt10_prob.csv",header='id')
